...
def search_builtin_patterns(task_description):
    ...
    keyword_map = {
        ...
        "batch|batch_norm|batchnorm|normalization|归一化|BN层|batch normalization|layer norm|layer_norm|instance norm|训练模式|推理模式|running_mean|running_var|gamma|beta|moving_average|momentum|梯度计算|dy|dx|dgamma|dbeta|反向传播|backward": "batch_norm_pattern",
